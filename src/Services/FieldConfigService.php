...
final class FieldConfigService
{
    ...
    public function registerFieldConfigs(): void
    {
        foreach ($this->getFieldtypesWithPrompts() as $fieldtype => $settings) {
            ...
            $config['magic_actions_action'] = [
                'type' => 'select',
                'display' => __('magic-actions::magic-actions.field_config.actions.display'),
                'multiple' => true,
    ...
    private function defaultFieldConfig(): array
    {
        return [
            'magic_actions' => [
                'type' => 'section',
                'display' => __('magic-actions::magic-actions.field_config.section.display'),
            ],
            'magic_actions_enabled' => [
                'type' => 'toggle',
                'display' => __('magic-actions::magic-actions.field_config.enabled.display'),
                'default' => false,
            ],
            'magic_actions_source' => [
                'type' => 'text',
                'display' => __('magic-actions::magic-actions.field_config.source.display'),
                'instructions' => __('magic-actions::magic-actions.field_config.source.instructions'),
                'placeholder' => __('magic-actions::magic-actions.field_config.source.placeholder'),
                'sometimes' => ['magic_actions_enabled' => true],
                'if' => ['magic_actions_enabled' => true],
            ],
            'magic_actions_mode' => [
                'type' => 'select',
                'display' => __('magic-actions::magic-actions.field_config.mode.display'),
                'instructions' => __('magic-actions::magic-actions.field_config.mode.instructions'),
                'options' => [
                    'append' => __('magic-actions::magic-actions.field_config.mode.options.append'),
                    'replace' => __('magic-actions::magic-actions.field_config.mode.options.replace'),
                ],
                'default' => 'append',
                'sometimes' => ['magic_actions_enabled' => true],
                'if' => ['magic_actions_enabled' => true],
